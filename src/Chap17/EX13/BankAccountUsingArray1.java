...
class Account { //계좌 정보를 저장하는 객체. 중요한 필드, private(캡슐화), 생성자(0),getter(0),setter(0),    // DTO, VO <== 각계층으로 필드의 값을 저장하고 전달
...
public class BankAccountUsingArray1 {
	...
	private static Account[] accountArray = new Account[100]; // 배열에 객체 저장.
			...
			// 배열 생성시 방(index) 의 크기를 선언, index = 0, 방의 갯수 length() <== 배열방의 갯수
