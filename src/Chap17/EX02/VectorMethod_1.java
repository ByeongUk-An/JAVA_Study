...
//Vector : ArrayList 와 동일 하게 사용.
	//Vector 는 모든 메서드가 동기화 처리가 되어 있다. 멀티쓰레드 환경에 사용되도록 되어있다.
...
public class VectorMethod_1 {
	...
	public static void main(String[] args) {
		...
		vector1.add(1, 19); // 방번호 1번에 19를 추가, 기존 1번 인덱스는 뒤로 밀려난다.
		...
		vector2.addAll(vector2); // aList1에 저장 된 값을 복사해서 aList2의 끝방에 붙여넣는다.
		...
		System.out.println(vector3);  //List 일떄 객체를 출력 하면 객체의 값을 출력함.
