...
public class TreeMapMethod_2 {
	public static void main(String[] args) {
		...
		//1. MyClass 를 TreeMap의 Key로 인풋 할 경우 : 실행ㅅ히 오류
		/*
		...
		treeMap1.put(m1, "첫번째");  //Comparable,Comparator 구현하지않음, TreeMap의 Key로 사용, 실행시 오류
		treeMap1.put(m2, "두번째");
		...
		MyComparableClass my3 = new MyComparableClass(4,3);
