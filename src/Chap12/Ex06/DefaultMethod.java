...
//Interface 의 default 메소드 : 인터페이스 내에서 구현부가 있는 메소드를 정의 할 때 사용
	// 기존의 구현되어 있는 인터페이스에서 새로운 기능을 추가할때 하위 클래스에서 재정의 필요없이 새로운 기능을 추가 할 때 사용.
...
interface A {
	void abc(); // 2005년 생성한 메소드 , public abstract 가 생략됨. 구현부가 없는 추상 메소드
