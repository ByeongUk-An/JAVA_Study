...
class A {
	...
	void method1() {	//인스턴스 메소드 : 객체 생성 후에 접근이 가능.
		System.out.println("Instance Method");
	}
	static void method2() {	// static 메소드 , 객체를 생성하지 않고 접근, 객체 생성 후에도 접근가능
		System.out.println("Static Method");
	}
	static class B { //static 이너클래스 : 외부 객체를 생성하지 않고 객체 생성이 가능하다.
		void bcd() {
