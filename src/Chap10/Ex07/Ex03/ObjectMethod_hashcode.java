...
// HashMap : key = value 저장되는 자료구조.
//key 는 절대로 중복되면 안된다.
//HashMap에 Key에 객체를 저장할 경우, key에 저장되는 객체가 중복되지 않는 고유한 정보를 저장.
...
class B {		//hashCode() + equals() 재정의  <<=== 동일한 객체로 인식
	String name;
...
public class ObjectMethod_hashcode {
	...
	public static void main(String[] args) {
		...
		hm1.put(1, "data1");
		hm1.put(1, "data2"); // 1 : data1 ==> data2
		hm1.put(2, "data3");

		System.out.println(hm1); // {1=data2, 2=data3}
