...
//제네릭 클래스의 상속 : 자식 클래스는 부모 클래스의 제네릭 변수(K,V,T,E) 와 같거나 더 많아야 된다.
...
class Child2 <T,V> extends Parent<T> {  //제네릭클래스를 상속 받는 자식 클래스는 부모의 타입의 인자갯수와 같거나 커야한다.
	V v;
...
public class InheritanceGenericClass {
	public static void main(String[] args) {
		...
		c2.setT("안녕");  //부모 클래스의 메소드
		c2.setV(100);	//자식 클래스의 메소드
		System.out.println(c2.getT());	//부모 클래스의 메소드
